...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row intro py-1" style="background-color : #99b3ff;">
    ...
    <div class="row activity text-center">
      ...
      <div class="col-md act">
        ...
        <br>
        <a href="transfermoney.php"><button style="background-color : #0044cc;">Make a Transaction</button></a>
      </div>
      <div class="col-md act">
  ...
  <footer class="text-center mt-5 py-2">
    <p>&copy 2021 Copyright : Made by <b>Manish Yadav</b></p>
  </footer>
